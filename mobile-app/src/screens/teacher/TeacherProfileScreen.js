    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.profileCard}>
        <Pressable onPress={handlePickPhoto} style={styles.avatarWrapper}>
          ...
          <View style={styles.cameraBadge}>
            {uploadingPhoto ? <ActivityIndicator size="small" color={colors.white} /> : <Feather name="camera" size={13} color={colors.white} />}
          </View>
        </Pressable>
      ...
      <View style={styles.menuCard}>
        {menuItems.map((item, index) => (
          <Pressable key={item.label} style={[styles.menuRow, index < menuItems.length - 1 && styles.menuRowBorder]} onPress={() => item.screen && navigation.navigate(item.screen)}>
...
const styles = StyleSheet.create({
  ...
  profileCard: { alignItems: 'center', backgroundColor: colors.white, borderRadius: spacing.radiusLg, marginHorizontal: spacing.space5, padding: spacing.space6, marginBottom: spacing.space5 },
  avatarWrapper: { position: 'relative', marginBottom: spacing.space3 },
  avatarImg: { width: 80, height: 80, borderRadius: spacing.radiusFull },
  avatarFallback: { width: 80, height: 80, borderRadius: spacing.radiusFull, backgroundColor: colors.primary, alignItems: 'center', justifyContent: 'center' },
  avatarText: { color: colors.white, fontSize: 32, fontWeight: typography.weightBold },
  cameraBadge: { position: 'absolute', bottom: 0, right: 0, width: 26, height: 26, borderRadius: spacing.radiusFull, backgroundColor: colors.primary, alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: colors.white },
  ...
  menuCard: { backgroundColor: colors.white, borderRadius: spacing.radiusLg, marginHorizontal: spacing.space5, marginBottom: spacing.space5, overflow: 'hidden' },
  ...
  menuIconWrap: { width: 34, height: 34, borderRadius: spacing.radiusMd, backgroundColor: colors.gray50, alignItems: 'center', justifyContent: 'center' },
  menuLabel: { flex: 1, fontSize: typography.fontSizeSm, color: colors.gray900 },
  logoutButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: spacing.space2, marginHorizontal: spacing.space5, backgroundColor: colors.white, borderRadius: spacing.radiusLg, padding: spacing.space4 },
